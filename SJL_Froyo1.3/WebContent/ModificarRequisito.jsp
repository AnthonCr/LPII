...
<html lang="en">
  ...
  <%
    ...
    String estado=(String)request.getParameter("est");
    Integer est=Integer.parseInt(estado);
  %>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="ModificarRequisito.jsp">Modificar</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <div class="form-panel">
            ...
            <form action="Requisito">
            	<table>
            		<input type="hidden" value="modificar" name="opt"/>
					<tr>
						<td style="padding: 10px;"><label>Codigo</label></td>
						<td style="padding: 10px;"><input type="text" class="form-control" value="<%=cod %>" name="cod"></td>
						<td style="padding: 10px;"><input type="submit" class="btn btn-theme" value="Grabar"/></td>
					</tr>
					<tr>
						<td style="padding: 10px;"><label>Nombre de Tramite</label></td>
						<td style="padding: 10px;"><input type="text" class="form-control" value="<%=desc %>" name="desc"></td>
					</tr>
					<tr>
						...
						<td style="padding: 10px;">
							<select class="form-control" name="estado">
								<%if(est==0){%>
								<option selected="selected" value="0">Activado</option>
								<option value="1">Desactivado</option>
								<%}else{ %>
								<option value="0">Activado</option>
								<option selected="selected" value="1">Desactivado</option>
								<%} %>
							</select>
						</td>
					</tr>
