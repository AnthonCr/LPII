  ...
  <section id="container" >
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a  href="ModificarExpediente.jsp">Modificar</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          ...
          <div class="form-panel">
            ...
            <table class="table table-striped">
				...
				<tr>
					...
					<td></td>
					<td></td>
					<td><input type="button" value="Notificar" data-toggle="modal" href="index.jsp#myModalNotificacion"/></td>
				</tr>
			</table>
          </div>
		...
		<!-- Modal -->
		          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="myModalNotificacion" class="modal fade">
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      <div class="modal-header">
		                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                          <h4 class="modal-title">Generar Notificacion</h4>
		                      </div>
