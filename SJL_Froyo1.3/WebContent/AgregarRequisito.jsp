...
<html lang="en">
  ...
  <%
  	ArrayList<Requisitos> list=(ArrayList<Requisitos>) request.getAttribute("lista");
 	String est;
  %>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="Requisito?opt=listar">Agregar</a></li>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Requisitos</h3>
          </section>
          <div class="form-panel">
            ...
            <table class="table table-striped">
				...
				<% if(list!=null){ 
					for(Requisitos re:list){
				%>	
				
				<tr>
					<td><%=re.getCodRequisito() %></td>
					<td><%=re.getDescripcion() %></td>
					<%if(re.getEstado()==0){est="Activo";}else{est="Desactivado";} %>
					<td><%=est%></td>
					<td><a href="ModificarRequisito.jsp?cod=<%=re.getCodRequisito()%>&desc=<%=re.getDescripcion()%>&est=<%=re.getEstado()%>">Modificar</a></td>
					<td><a href="Requisito?opt=eliminar&cod=<%=re.getCodRequisito()%>">Eliminar</a></td>
				</tr>
				<%}}%>
			</table>
			<input type="button" value="Agregar" class="btn btn-theme" data-toggle="modal" href="AgregarRequisito.jsp#ModalRequisito"> 
          </div>
          
      </section>
		<!-- Modal -->
		          <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="ModalRequisito" class="modal fade">
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      <div class="modal-header">
		                          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
		                          <h4 class="modal-title">Requisito Nuevo</h4>
		                      </div>
		                      <form action="Requisito?opt=agregar" method="post">
		                      	<div class="modal-body">
		                          <label>Nombre de Requisito : </label>
		                      		<input type="text" class="form-control" name="nombreReq">
			                    </div>
			                    <div class="modal-footer">
			                          <button data-dismiss="modal" class="btn btn-default" type="button">Cancelar</button>
			                          <button class="btn btn-theme" type="submit">Confirmar</button>
